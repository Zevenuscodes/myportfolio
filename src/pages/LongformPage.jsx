    ...
    >
      ...
      <div
        ...
        style={{
          ...
          transition: 'box-shadow 0.3s', cursor: 'pointer', overflow: 'hidden',
        }}
      >
        <video
          ref={videoRef}
        ...
        >
          <motion.div
            ...
            style={{
              ...
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              boxShadow: '0 0 24px rgba(0,245,255,0.3)', background: 'rgba(3,4,10,0.6)',
            }}
          >
            <span style={{
        ...
        {playing && (
          <div style={{ position: 'absolute', top: '14px', right: '14px', display: 'flex', alignItems: 'center', gap: '6px', pointerEvents: 'none' }}>
            ...
            />
            <span style={{ fontFamily: 'Share Tech Mono, monospace', fontSize: '0.42rem', letterSpacing: '3px', color: 'var(--cyan)', textTransform: 'uppercase' }}>
              Playing
            </span>
          </div>
        )}
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginTop: '1.2rem' }}>
        <div>
          <div style={{
            ...
            color: 'rgba(0,245,255,0.4)', textTransform: 'uppercase', marginBottom: '0.3rem',
          }}>
            {project.client}
          </div>
          <h3 style={{
            fontFamily: 'Orbitron, monospace', fontSize: '1rem', fontWeight: 700,
            color: 'var(--text-main)', letterSpacing: '2px', margin: 0,
          }}>
            {project.title}
          </h3>
          <p style={{
            fontFamily: 'Share Tech Mono, monospace', fontSize: '0.6rem', lineHeight: '1.8',
        ...
        <div style={{
          fontFamily: 'Share Tech Mono, monospace', fontSize: '0.42rem', letterSpacing: '3px',
          color: 'rgba(255,255,255,0.15)', textTransform: 'uppercase', textAlign: 'right', flexShrink: 0,
        }}>
